  ...
  <section class="py-4">
    <div>
      <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl md:text-2xl font-bold text-orange-500 uppercase tracking-wide border-b-2 border-orange-500/20 pb-1">
          {{ title }}
        </h2>
        
        <div class="flex items-center gap-2">
          <div v-if="displayLoading" class="text-sm text-orange-400 animate-pulse mr-2 hidden sm:block">
            Carregando...
          </div>
      ...
      <div v-if="displayError" class="text-red-400 bg-red-900/20 p-4 rounded-lg text-center text-sm mb-4 border border-red-500/30">
      ...
      <div v-if="!displayLoading && !displayError && displayProducts.length === 0" class="text-neutral-500 text-center py-12">
