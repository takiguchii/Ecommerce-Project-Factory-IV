...
public static class SeedData
{
    public static void Initialize(EcommerceDbContext context)
    {
        ...
        // 3. Criar Subcategorias para TODAS as categorias
        ...
        context.SubCategories.AddRange(placasDeVideo, notebooks, mouses, headsets, consoles, acessoriosGamer, monitores, smartphones, smartTvs, fonesDeOuvido, assistentesVirtuais);
        context.SaveChanges();

        // 4. Criar Produtos com as URLs corretas
        var products = new List<Product>
        {
            new Product {
                Name = "Placa de Vídeo ASRock RX 6600 Challenger White", OriginalPrice = 1399.99m, DiscountPrice = 1299.99m,
                Description = "Placa de vídeo com design branco para jogos em Full HD, com 8GB de memória GDDR6.", TechnicalInfo = "8GB GDDR6, DirectX 12 Ultimate",
                RawDescription = "Placa de vídeo com design branco para jogos em Full HD, com 8GB de memória GDDR6.", RawTechnicalInfo = "8GB GDDR6, DirectX 12 Ultimate",
            ...
            new Product {
                ...
                Description = "Experimente o carregamento ultrarrápido com o SSD de altíssima velocidade e uma geração totalmente nova de jogos.", TechnicalInfo = "CPU AMD Ryzen Zen 2, GPU AMD Radeon RDNA 2, 16GB GDDR6",
                RawDescription = "Experimente o carregamento ultrarrápido com o SSD de altíssima velocidade e uma geração totalmente nova de jogos.", RawTechnicalInfo = "CPU AMD Ryzen Zen 2, GPU AMD Radeon RDNA 2, 16GB GDDR6",
            ...
            new Product {
                ...
                Description = "Performance de última geração com processador Intel Core i5 de 13ª Geração e placa de vídeo NVIDIA GeForce RTX 4050.", TechnicalInfo = "8GB RAM DDR5, SSD 512GB NVMe, RTX 4050 6GB",
                RawDescription = "Performance de última geração com processador Intel Core i5 de 13ª Geração e placa de vídeo NVIDIA GeForce RTX 4050.", RawTechnicalInfo = "8GB RAM DDR5, SSD 512GB NVMe, RTX 4050 6GB",
            ...
            new Product {
                Name = "Mouse Gamer Redragon Cobra Chroma RGB", OriginalPrice = 119.99m,
                Description = "Mouse ergonômico com 7 botões programáveis e iluminação RGB para máxima performance em jogos.", TechnicalInfo = "Sensor PMW3325, 10000 DPI, Iluminação Chroma RGB",
                RawDescription = "Mouse ergonômico com 7 botões programáveis, iluminação RGB e sensor de alta precisão para máxima performance em jogos.", RawTechnicalInfo = "Sensor PMW3325, 10000 DPI, Iluminação Chroma RGB",
            ...
            new Product {
                ...
                Description = "Leveza e conforto com áudio imersivo. Drivers de 50mm e microfone com cancelamento de ruído.", TechnicalInfo = "Drivers de 50mm, DTS Headphone:X Spatial Audio",
                RawDescription = "Leveza e conforto com áudio imersivo. Drivers de 50mm e microfone com cancelamento de ruído.", RawTechnicalInfo = "Drivers de 50mm, DTS Headphone:X Spatial Audio",
            ...
            new Product {
                ...
                Description = "Ideal para produtividade, com processador de 8 núcleos, 16GB de RAM e design fino.", TechnicalInfo = "16GB RAM DDR4, SSD 512GB NVMe, Tela 15.6\" Full HD IPS",
                RawDescription = "Ideal para trabalho e produtividade, com processador de 8 núcleos, 16GB de RAM e design fino e leve.", RawTechnicalInfo = "16GB RAM DDR4, SSD 512GB NVMe, Tela 15.6\" Full HD IPS",
            ...
            new Product {
                ...
                Description = "Placa de vídeo com 8GB de memória GDDR6 e design de resfriamento com duas ventoinhas.", TechnicalInfo = "8GB GDDR6, Clock de até 2491 MHz, Suporte a 8K",
                RawDescription = "Placa de vídeo com 8GB de memória GDDR6 e design de resfriamento com duas ventoinhas.", RawTechnicalInfo = "8GB GDDR6, Clock de até 2491 MHz, Suporte a 8K",
            ...
            new Product {
                ...
                Description = "Potência e velocidade com o processador Intel Core i7 de 13ª geração e placa de vídeo RTX 4050.", TechnicalInfo = "Intel Core i7-13620H, 16GB RAM DDR5, RTX 4050 6GB",
                RawDescription = "Potência e velocidade com o processador Intel Core i7 de 13ª geração e placa de vídeo RTX 4050.", RawTechnicalInfo = "Intel Core i7-13620H, 16GB RAM DDR5, RTX 4050 6GB",
            ...
            new Product {
                ...
                Description = "Headset com som surround, microfone plug-and-play e compatibilidade multiplataforma.", TechnicalInfo = "Drivers de 53mm, Plug 3.5mm, Design over-ear",
                RawDescription = "Headset com som surround, microfone plug-and-play e compatibilidade multiplataforma.", RawTechnicalInfo = "Drivers de 53mm, Plug 3.5mm, Design over-ear",
            ...
            new Product {
                ...
                Description = "Liberdade sem fios com a tecnologia Lightspeed, sensor HERO de alta performance e longa duração de bateria.", TechnicalInfo = "Sensor HERO 12.000 DPI, 6 Botões Programáveis",
                RawDescription = "Liberdade sem fios com a tecnologia Lightspeed, sensor HERO de alta performance e longa duração de bateria.", RawTechnicalInfo = "Sensor HERO 12.000 DPI, 6 Botões Programáveis",
            ...
            new Product {
                ...
                Description = "Sinta cada derrapagem e curva com o Force Feedback realista. Volante para PS5, PS4, PS3 e PC.", TechnicalInfo = "Rotação de 900 graus, Force Feedback de motor duplo",
                RawDescription = "Sinta cada derrapagem e curva com o Force Feedback realista. Volante para PS5, PS4, PS3 e PC.", RawTechnicalInfo = "Rotação de 900 graus, Force Feedback de motor duplo",
            ...
            new Product {
                ...
                Description = "Monitor de alta performance com taxa de atualização de 180Hz e 1ms de tempo de resposta.", TechnicalInfo = "Tela de 24\" Full HD, 180Hz, 1ms (GtG), HDR10, AMD FreeSync",
                RawDescription = "Monitor de alta performance com taxa de atualização de 180Hz e 1ms de tempo de resposta para jogabilidade ultra fluida.", RawTechnicalInfo = "Tela de 24\" Full HD, 180Hz, 1ms (GtG), HDR10, AMD FreeSync",
